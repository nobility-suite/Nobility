...
public enum ButtonLibrary {
	...
	public static ItemStack createIcon(Material mat, String name) {
		...
		ItemUtils.setDisplayName(icon, ChatColor.WHITE + name);
		return icon;
	}
	
	public static Clickable createResearchTutorial() {
		ItemStack icon = createIcon(Material.BOOK, ChatColor.WHITE + "Research Tutorial");
		ItemUtils.addLore(icon, ChatColor.GRAY + "Choose a card to progress your Blueprint.");
		ItemUtils.addLore(icon, ChatColor.GRAY + "Your choices allow you to influence the final outcome.");
		ItemUtils.addLore(icon, ChatColor.GRAY + "Each round you will be shown a new set of cards.");
	...
	public static Clickable createWorkshopInfo(Development d) {
		...
		ItemUtils.addLore(icon, ChatColor.BLUE + "Workshop Type: " +  ChatColor.WHITE + d.name, ChatColor.GRAY + d.useDescription);
		Clickable ret = new DecorationStack(icon);
		return ret;
	}
	...
	public static Clickable createWorkerInfo(Player p) {
		...
		ItemUtils.addLore(playerIcon, ChatColor.BLUE + "Workers: " + ChatColor.WHITE + workers,
	...
	public static Clickable createEstateInfo(Estate e) {
		...
		ItemUtils.addLore(info, ChatColor.BLUE + "City Radius: " + ChatColor.WHITE + radius);
